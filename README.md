# Available .INSURE One-Word Domains (18,170)
...
**Public extract:** 1,000 rows · **Live catalog:** 18,170 domains · **Median ask:** $11.67 · **High-demand under $2,500:** 2
...
| ---------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------- |
| something.insure | available | $9.99     | —             | high           | low    | 9      | name.com          |
...
> Unique Domains. *Available .INSURE One-Word Domains*. Version 2026-08-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
